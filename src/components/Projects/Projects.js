...
export const Projects = () => {
  return (
    <section className="projects">
      <h2 className="projects__title">Proyectos que realize</h2>
      <div className="primary__projects">
        <div className="project">
          ...
          <div className="project_content">
            <h3>Descripción</h3>
            <p>
              Qui in tempor commodo do elit exercitation et nulla
              irure eu sit. Ut Lorem ex elit pariatur voluptate
              occaecat ex culpa nisi quis. Aliquip duis commodo non
              anim culpa irure culpa amet non esse anim laborum veniam
              do. Eiusmod elit sit dolore laboris excepteur aliqua
              cupidatat. Quis id non id
            </p>
